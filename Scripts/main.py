# This is not really efficient, and surely not the
# best way to do this. It was the fastest way to do it
# and 
...
ser = serial.Serial("COM4", 1000000,
                    serial.EIGHTBITS, serial.PARITY_NONE, serial.STOPBITS_ONE,timeout=None)
